			...
			<center>
				...
				<table border="0"  style="text-align:left;">
					...
					<tr>
						...
						<td><input name="username" type="text" value="" tabindex="1" placeholder="Username"></td>
					</tr>
					<tr>
						
						<td><input name="password" type="password" value="" tabindex="2" placeholder="Password"></td>
					</tr>
					<tr>
						<td>Remember login:<input type="checkbox" name="remember" tabindex="3"></td>
					</tr>
					<tr>
						
						<td><input type="submit" value="Login" tabindex="4"></td>
					</tr>
					<td>New User? <a href="./admin.php">Register!</a></td>
				</table>

				<?php
				if (strtolower (basename ($_SERVER['SCRIPT_NAME'])) == "index.php") {
					echo '<br><div><a href="./shared.php"></a></div>';
				}
				?>
